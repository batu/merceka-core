...
# AUTOGENERATED by nbsync — DO NOT EDIT. Source: ../nbs/00_llm.ipynb
#
# LLM EDITING GUIDE:
...
# %% auto 0
__all__ = ['list_local_models', 'create_message', 'create_message_with_resource', 'create_ollama_vision_message', 'tool_from_callable', 'OutputSchema', 'Tool', 'LLM', 'CLAUDE_CLI_TIMEOUT']
...
class LLM:
  ...
  def __init__(
    ...
    if not self.use_openrouter and not self.use_claude:
      self._verify()
  ...
  def generate(self, message: str, **kwargs) -> str | OutputSchema:
    ...
    try:
      return self._generate_primary(message, **kwargs)
            ...
            FileNotFoundError, ConnectionError, OSError) as e:
      if self.fallback:
