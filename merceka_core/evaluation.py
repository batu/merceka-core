...
# AUTOGENERATED by nbsync — DO NOT EDIT. Source: ../nbs/01_evaluation.ipynb
#
# LLM EDITING GUIDE:
# - Edit code within existing cell blocks (between # %% markers)
# - Do not add code between cell blocks — it will be lost on re-export
# - Do not modify __all__ or this header — they are regenerated
# - Run `nbsync update` to sync your changes back to the source notebook
# - Help: `nbsync --help` | Docs: see README.md in the nbsync package

# %% auto 0
__all__ = ['get_git_hash', 'config_name', 'Evaluation', 'TaskResult', 'ExperimentResults', 'Task', 'Evaluator', '_detect_calling_convention', '_generate_save_path', '_check_duplicate_config_names', '_check_duplicate_evaluation_names', 'Experiment', 'run_experiment', 'to_dataframe']
